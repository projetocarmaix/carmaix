 ...
 */
public class DialogAlterarSenhaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.main_container_dialog, new DialogAlterarSenhaFragment()).commit();
    }
}
